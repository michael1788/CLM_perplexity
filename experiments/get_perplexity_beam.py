...
parser = argparse.ArgumentParser(description='Get the perplexity on beam generated SMILES')
...
if __name__ == '__main__':
    ...
    if repeat>0:
        savepath = f'{dir_exp}/{mode}/{exp_name}/{name_data}/perplexity_beam/{width}/{repeat}/'
        dir_data = f'{dir_exp}/{mode}/{exp_name}/{name_data}/proba_extraction_beam/{width}/{repeat}/'
    else:
        savepath = f'{dir_exp}/{mode}/{exp_name}/{name_data}/perplexity_beam/{width}/'
        dir_data = f'{dir_exp}/{mode}/{exp_name}/{name_data}/proba_extraction_beam/{width}/'
